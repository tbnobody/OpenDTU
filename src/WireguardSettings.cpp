...
void WireguardSettingsClass::beginWireGuard()
{
    ...
    wg.begin(
        ...
        Configuration.get().Wg_Opendtu_Allowed_Ip, // Allowed local IP address
        Configuration.get().Wg_Opendtu_Allowed_Mask, // Define routing range of Wireguard VPN
        IPAddress(255, 255, 255, 0), //  Netmask
        IPAddress(0, 0, 0, 0), // Gateway
